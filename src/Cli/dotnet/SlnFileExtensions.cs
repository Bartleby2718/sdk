...
internal static class SlnFileExtensions
{
    ...
    public static void AddSolutionFolder(this SlnFile slnFile, string fullFolderPath, IList<string> solutionFolders)
    {
        ...
        {
            Reporter.Output.WriteLine(string.Format(
                CommonLocalizableStrings.SolutionAlreadyContainsFolder,
                slnFile.FullPath,
                relativeProjectPath));
        }
        else
        {
            ...
            Reporter.Output.WriteLine(
                string.Format(CommonLocalizableStrings.SolutionFolderAddedToTheSolution, relativeProjectPath));
        }
    }

    public static bool SolutionFolderContainsSolutionItem(this SlnFile slnFile, string solutionFolder, string fullFilePath)
    {
    ...
    public static void AddSolutionItem(this SlnFile slnFile, string relativeFilePath, IList<string> solutionFolderNames)
    {
        ...
        Reporter.Output.WriteLine($"solutionFolderNames: [{string.Join(", ", solutionFolderNames)}]");
        if (solutionFolderNames == null)
        {
            Reporter.Output.WriteLine($"solutionFolderNames: null");
        ...
        for (int i = 0; i < solutionFolderNames.Count; i++)
        {
            ...
            Reporter.Output.WriteLine($"currentSolutionFolderName: {currentSolutionFolderName}");
            ...
            if (i > 0 && nestedProjectsSection != null)
            {
                ...
                Reporter.Output.WriteLine($"TryAdd previousSolutionFolder {previousSolutionFolder}");
            ...
            {
                Reporter.Output.WriteLine("last one");
        ...
        string relativeFilePath)
    {
        ...
        Reporter.Output.WriteLine($"solutionFolder: {solutionFolder.Name}, relativeFilePath: {relativeFilePath}");
        ...
        {
            Reporter.Output.WriteLine("TryAdd if");
            // TODO: I'm definitely setting the content here, but the slnFile is not being updated.
            ...
            Reporter.Output.WriteLine($"solutionItemsAfterAddition.GetContent(): {stringifiedDictionary}");

            Reporter.Output.WriteLine(string.Format(CommonLocalizableStrings.SolutionItemAddedToTheSolution, relativeFilePath, solutionFolder.Name));
        }
        else
        {
            throw new GracefulException(string.Format(
                CommonLocalizableStrings.SolutionAlreadyContainsFile,
                slnFile.FullPath,
                relativeFilePath));
        }
    }
